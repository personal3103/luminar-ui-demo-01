...
# 2. src/index.css
# Clean pure zinc Tailwind theme
...
@layer base {
  html, body {
    ...
    @apply bg-zinc-950 text-zinc-50 antialiased selection:bg-indigo-500/30 font-inter;
  }
}
...
@layer utilities {
  ...
  .glass-hover {
    @apply hover:bg-zinc-800/60 hover:border-white/20 transition-all duration-300;
  }
}
...
# 3. src/components/AmbientCanvas.tsx
# High performance vanilla canvas interactive particle grid
canvas_tsx = """import { useEffect, useRef } from "react";
...
"""
with open(os.path.join(components_dir, 'AmbientCanvas.tsx'), 'w', encoding='utf-8') as f:
    f.write(canvas_tsx)

print("Setup utils, CSS, and Canvas complete.")
